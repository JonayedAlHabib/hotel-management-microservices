...
// requireAuth is now `async` (it looks the user up to check tokenVersion), so it needs
// asyncHandler too — same reason the controllers do. A plain sync throw would still be
